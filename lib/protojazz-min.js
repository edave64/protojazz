...
$.global=$.proto(function(){},{parent:function(b){if(typeof this._parent[b]=="function")return this._parent[b].apply(this,[].slice.call(arguments,1));return this._parent[b]},init:function(){}});